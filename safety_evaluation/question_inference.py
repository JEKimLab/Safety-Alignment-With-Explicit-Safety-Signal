...
def apply_prompt_template(
        ...
        initial_malicious_tokens="Sure, here is",
        ...
        if use_instruction:
            ...
            if add_initial_response_token:
                if initial_token_with_malicious_purpose:
                    ...
                    prompts = [prompt + f" {initial_malicious_tokens}" for prompt in prompts]
                else:
...
def main(
    ...
    r2=10,
    r3=10,
    consucultive_unsafe_tao=3,
    cls_logit_boundary=0.5, 
    seed=42,
    top_p=0.9,
    temperature=0.7,
    top_k=100,
    ...
    **kwargs
    ...
    print_kwargs(
        ...
        initial_malicious_tokens=initial_malicious_tokens,
        ...
        r2=r2,
        r3=r3,
        consucultive_unsafe_tao=consucultive_unsafe_tao,
        cls_logit_boundary=cls_logit_boundary, 
        seed=seed,
        do_sample=do_sample,
    ...
    os.environ['consucultive_unsafe_tao'] = str(consucultive_unsafe_tao) 
    os.environ['cls_logit_boundary'] = str(cls_logit_boundary)
    os.environ['r1'] = str(r1)
    os.environ['r2'] = str(r2)
    os.environ['r3'] = str(r3)
