...
PROMPT_FILE="/home/jli265/workspace/llama-recipes/safety_evaluation/data/inception_attacks.csv"
OUTPUT_FILE="safety_evaluation/question_outputs/inception_output.json"
MAX_NEW_TOKENS=512
