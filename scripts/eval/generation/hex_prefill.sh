...
PROMPT_FILE="/home/jli265/workspace/llama-recipes/safety_evaluation/data/hex-phi/all.csv"
OUTPUT_FILE="safety_evaluation/question_outputs/hex_prefill_output.json"
MAX_NEW_TOKENS=512
