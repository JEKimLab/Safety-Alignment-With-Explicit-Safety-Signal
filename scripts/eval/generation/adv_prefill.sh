...
PROMPT_FILE="/home/jli265/workspace/llama-recipes/safety_evaluation/data/harmful_behaviors.csv"
OUTPUT_FILE="safety_evaluation/question_outputs/adv_prefill_output.json"
MAX_NEW_TOKENS=512
...
python safety_evaluation/question_inference.py \
